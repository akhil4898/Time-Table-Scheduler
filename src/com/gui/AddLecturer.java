...
public class AddLecturer extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADD LECTURER INFORMATION PAGE");
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
        if(name.getText().trim().equals("") ||
            ...
            try{
                ...
                JOptionPane.showMessageDialog(this, "Lecturer information has been saved","Success",JOptionPane.INFORMATION_MESSAGE);
                AddLecturer reg = new AddLecturer();
